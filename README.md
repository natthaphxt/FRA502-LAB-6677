...
1. **Clone the repository** To clone my work:
   ```bash
   git clone -b LAB2 https://github.com/natthaphxt/FRA502-LAB-6677.git
    ```
2. **Run killer nodes** :
   ```bash
...
3. **Run eater nodes** :
   ...
   ```
4. **Run turtlesim_pose nodes** :
   ```bash
   ros2 run lab2 turtlesim_pose.py
   ```
5. **Run turtlesim_.plus nodes** :
   ```bash
...
6. **Launch File If you lazy** :
   ```bash
   ros2 launch lab2 turtle_launch.py 
```
```
